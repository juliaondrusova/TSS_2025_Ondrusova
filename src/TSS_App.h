...
protected:
    ...
    /**
     * @brief Called when the application window is closing.
     * @param event Close event instance.
     *
     * @details Saves all application settings before closing.
     */
...
private:
    ...
    /**
     * @brief Loads saved application settings from registry.
     *
     * @details Restores:
     * - Window geometry and state
     * - Last opened folder
     * - Dark mode preference
     * - Table model settings (page size, sorting, filters)
     * - Column widths
     */
    void loadSettings();

    /**
     * @brief Saves current application settings to registry.
     *
     * @details Stores:
     * - Window geometry and state
     * - Current folder path
    ...
    QString m_currentFolderPath; ///< Currently opened folder path
